...
BASE_DIR="results_ackley_unconstrained_gp" # Fixed base directory name
FUNCTION_NAME="ackley"
ITER_BO=500
N_STARTUP_TRIALS=1
DIMENSION=2
SAMPLER_TO_RUN="gp"
SEEDS=(0 1 0 1) # Example seeds - adjust as needed
PAUSE_AFTER_N_SEEDS=10
...
JOB_DURATION="4:00:00"           # Time limit *per job*
...
run_experiment() {
    ...
    local base_dir=$3 # Pass base directory (e.g., results_ackley_unconstrained_gp)
    ...
    local job_name="ackley_uncon_${sampler}_s${seed}_ts${timestamp}" # Make job name unique
...
# conda activate your_env_name # Adjust environment name
...
echo "Running unconstrained Ackley with GP sampler."
...
echo "All unconstrained Ackley GP jobs submitted!"